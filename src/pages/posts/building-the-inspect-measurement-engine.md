...
![Two layers which intersect](/images/blog/building-the-inspect-measurement-engine/overlapping.png)
![Two layers in relation to eachother](/images/blog/building-the-inspect-measurement-engine/relation.png)
...
![Each direction numbered from one to eight in relation to the center](/images/blog/building-the-inspect-measurement-engine/directions.png)
...
![Two shapes with their centers marked and a line drawn between the two to demonstrate the angle](/images/blog/building-the-inspect-measurement-engine/angle.png)
...
![Two layers which intersect](/images/blog/building-the-inspect-measurement-engine/intersection.png)
...
![Actual result](/images/blog/building-the-inspect-measurement-engine/actual.png)
![Expected](/images/blog/building-the-inspect-measurement-engine/expected.png)
...
I want to give a shout out to my manager at the time
[Ryan Scheuermann](https://twitter.com/rscheuermann) for helping me work through
some of the challenges, and both [Jeremy Wight](https://twitter.com/JeremyWight)
and [Blake Walters](https://twitter.com/markupboy) for helping review this post.
